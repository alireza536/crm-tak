...
export default new DataSource({
  ...
  migrations: [CustomerInvoiceArchitecture1786320060000, NullableCustomerPhone1786323660000, CustomerOwnershipStatus1786327260000, AddUserAuthenticationColumns1786410060000],
  synchronize: false,
});
