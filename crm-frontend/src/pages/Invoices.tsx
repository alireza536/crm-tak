      ...
      <section className="invoiceStatsGrid">
        ...
        <article className="invoiceStatCard">
          ...
          <div>
            ...
            <small>میانگین خرید {money(statistics.averageSale)} ریال</small>
          </div>
        </article>
      </section>
      ...
      <section className="invoiceWorkspace">
                ...
                {filteredRows.map((item, index) => {
                  ...
                  return (
                    <tr key={item.id ?? `${item.factor}-${index}`}>
                      ...
                      <td>
                        <strong className="invoiceMoney">{money(item.sale)} ریال</strong>
                      </td>
                      <td>
                        <span className="invoiceDiscount">{money(item.discount)} ریال</span>
                      </td>
                      <td>
        ...
        {!loading && !error && filteredRows.length > 0 && (
          <footer className="invoiceTableFooter">
            ...
            <strong>جمع نتایج: {money(statistics.totalSale)} ریال</strong>
          </footer>
        )}
      </section>
    </main>
